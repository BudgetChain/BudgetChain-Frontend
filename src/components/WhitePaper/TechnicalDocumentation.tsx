const TechnicalDocumentation = () => {
    return (<section className="text-white py-20 px-6 md:px-16 bg-gradient-to-b ">
        <div className="flex flex-col gap-5">
            <h2 className="text-4xl font-bold text-center">Technical Documentation</h2>
            ...
            <p className="text-gray-400 text-center max-w-3xl mx-auto mb-16">
                Here’s a breakdown of the core components powering <strong>BudgetChain</strong> — from decentralized methodologies to transparent finance tracking built on blockchain.
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            <div className="border rounded-xl p-6 shadow-lg hover:shadow-blue-500/30 transition-all">
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Blockchain-Based Budget Management</h3>
            ...
            {/* Card 2 */}
            <div className="border rounded-xl p-6 shadow-lg hover:shadow-blue-500/30 transition-all">
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Technology Stack Overview</h3>
                <ul className="text-sm text-gray-300 list-disc pl-5 space-y-1">
                    <li><strong>Frontend:</strong> React, Next.js, Tailwind CSS</li>
                    <li><strong>Backend:</strong> Node.js, Express, PostgreSQL</li>
                    <li><strong>Blockchain:</strong> Solidity, Polygon, Web3.js</li>
                    <li><strong>CI/CD:</strong> Docker, GitHub Actions</li>
                </ul>
            </div>

            {/* Card 3 */}
            <div className="border rounded-xl p-6 shadow-lg hover:shadow-blue-500/30 transition-all">
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Decentralized Finance Methodology</h3>
            ...
            {/* Card 4 */}
            <div className="border rounded-xl p-6 shadow-lg hover:shadow-blue-500/30 transition-all">
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Security & Transparency</h3>
