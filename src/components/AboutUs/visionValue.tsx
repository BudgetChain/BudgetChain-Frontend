...
const coreValues = [
    ...
    {
        title: "Innovation",
        description: "We constantly seek new ideas and embrace change to deliver breakthrough solutions.",
        icon: "svg/Icons.svg",
    },
    {
        title: "Excellence",
        description: "We strive for quality and professionalism in everything we do.",
        icon: "svg/Icons.svg",
    },
    {
        title: "Collaboration",
