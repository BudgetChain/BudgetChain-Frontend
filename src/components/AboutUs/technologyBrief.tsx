...
const technologyGroups = [
    {
        ...
        items: [
            {
                name: "React",
                description: "Builds seamless user interfaces for a responsive and intuitive experience.",
                icon: "svg/React-icon.svg",
            },
            {
                name: "Tailwind CSS",
                description: "Delivers fast and consistent UI styling across all pages.",
    ...
    },
    {
        ...
        items: [
            {
                name: "Node.js",
                description: "Drives our API logic and business rules with event-driven architecture.",
                icon: "svg/nodejs.svg",
            },
            {
                name: "Express",
    ...
    },
    {
        ...
        items: [
            {
                name: "Docker",
                description: "Isolates services for seamless CI/CD and scalable deployment.",
                icon: "svg/docker.svg",
            },
            {
                name: "GitHub Actions",
    ...
    },
    {
        ...
        items: [
            {
                name: "Solidity",
                description: "Powers our smart contracts for transparent financial flows.",
...
const TechnologyBrief = () => {
    return (
        <section className="text-white flex flex-col items-center justify-center py-16 px-8 md:px-16 bg-gradient-to-b ">
            ...
            <p className="text-gray-400 max-w-3xl text-center mb-16">{techBriefDescription}</p>
                    ...
                    <div key={idx}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            {group.items.map((tech, index) => (
                                <div
                                    key={index}
                                    className="flex flex-col items-center bg-[#131322] p-6 rounded-2xl shadow-lg hover:shadow-blue-500/30 hover:scale-105 transform transition-all text-center"
                                >
