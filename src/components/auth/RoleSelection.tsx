      ...
      <main className="flex-grow flex items-center justify-center p-4 mt-[-280px]">
        <div className="w-full space-y-8 max-w-[1010px]">
          <div className="mb-4 text-center lg:text-left">
            <h1 className="text-[#4F4AE6] text-2xl font-bold mb-1">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    >
                      {selectedRole === 'Investor' && (
                        <div className="h-3 w-3 rounded-full bg-[#4F4AE6] mx-auto mt-1"></div>
                      )}
                    </div>
                  </button>
