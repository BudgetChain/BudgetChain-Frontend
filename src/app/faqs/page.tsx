      ...
      questions: [
        {
          ...
          answer: 'Absolutely. BudgetChain employs multiple layers of security: 1) End-to-end encryption for all data transmissions, 2) Blockchain-based storage that\'s resistant to hacking, 3) Zero-knowledge proof authentication that never stores your credentials, 4) Optional biometric login for mobile devices, 5) Regular third-party security audits. Your data is protected with military-grade cryptography.'
        },
        {
          question: 'Who has access to my financial information?',
          answer: 'Only you have access to your complete financial information. BudgetChain uses advanced cryptographic techniques to ensure that even our engineers cannot view your sensitive data. When using bank connections, we follow strict read-only protocols and never store your banking login credentials. You maintain complete control over your data at all times.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'BudgetChain is available across all major platforms: 1) iOS and Android mobile apps, 2) Web application accessible from any modern browser, 3) Desktop applications for Windows and macOS. All versions sync seamlessly via our blockchain backend. We also offer browser extensions for quick transaction entry and API access for enterprise users.'
        },
        {
          question: 'How often is my data synced across devices?',
          answer: 'BudgetChain performs real-time synchronization thanks to our blockchain infrastructure. Any change made on one device is propagated to the network and reflected on all your other devices typically within 2-5 seconds. For bank transactions, we refresh connected accounts every 4 hours or immediately when you manually trigger a refresh.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'BudgetChain offers three tiers: 1) Free Plan - Basic budgeting with manual entry and limited history, 2) Premium ($9.99/month) - Automatic bank connections, advanced analytics, and smart contract rules, 3) Enterprise (custom pricing) - For businesses with team features and API access. All plans include our blockchain security features.'
        },
        {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#050512] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-6xl font-bold text-white mb-4 bg-gradient-to-r from-[#c4c4cf] via-[#9493cf] to-[#5B54FF] bg-clip-text text-transparent">Frequently Asked Questions</h1>
          <p className="text-lg text-gray-200 max-w-2xl mx-auto">
            Find quick answers to common questions about BudgetChain. Can't find what you're looking for? Contact our support team.
          </p>
        </motion.div>
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`h-5 w-5 text-gray-500 transform transition-transform duration-200 ${
                              activeQuestion === `${section.category}-${index}` ? 'rotate-180' : ''
                            }`}
                          />
                        </button>
                        <AnimatePresence>
                          {activeQuestion === `${section.category}-${index}` && (
                            <motion.div
