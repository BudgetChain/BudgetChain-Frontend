        ...
        {activeTab === "appeal" && (
          <div className="mt-0">
            <div className="bg-[#171720] shadow-[0px_0px_4px_0px_rgba(235,235,235,0.25)] my-5 rounded-lg p-6 relative">
              <button onClick={() => window.history.back()} className="flex items-center mb-10 text-muted-foreground ">
            ...
            <h2 className="text-lg font-semibold uppercase tracking-wider mb-6 pt-9">Request for more funds</h2>

            <div className="whitespace-pre-line tracking-widest">{appeal.description.split("\n").map((paragraph, index) => (
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rotate-12 opacity-80">
                ...
                <div className="text-right pr-16 mt-4 text-xs text-muted-foreground">
