...
const AIChat = () => {
  return (
    <div className="rounded-lg p-4 md:p-6 border space-y-4 md:space-y-6 gap-6 mt-6 border-gray-800">
      {/* Revenue Chart */}
      <div className="bg-[#111C44] rounded-xl p-4 md:p-6 w-full flex flex-col justify-center">
        <h3 className="text-gray-200 md:ml-10 text-sm md:text-base mb-4 md:mb-8">
          Revenue
        </h3>
        <div className="h-[220px] sm:h-[260px] md:h-[320px] lg:h-[360px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={revenueData}>
              ...
              <XAxis dataKey="week" stroke="#fff" tick={{ fontSize: 10 }} />
              <YAxis
                stroke="#fff"
                domain={[200, 2200]}
      ...
      <div className=" flex items-stretch md:flex-row flex-col md:justify-between gap-4 md:gap-6">
        {/* Pending Appeal */}
        <div className="bg-gray-900 rounded-lg px-4 md:px-8 py-4 border border-gray-800 w-full">
          ...
          <div className="flex mt-6 md:mt-9">
            <button className="flex-1 bg-indigo-600 py-2 text-white rounded-lg">
              View
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-900 rounded-lg p-4 md:p-6 border border-gray-800 flex flex-col justify-center w-full">
          <h2 className="font-bold mb-3 md:mb-4 text-gray-400 text-sm md:text-base">
            DAOs Funds Allocation
          </h2>
          ...
          <div className="flex justify-center md:justify-start">
            <div className="flex gap-3">
              ...
              <div className="mt-2 md:mt-6">
                <div className="flex items-center justify-center md:justify-start mt-2 md:mt-8">
