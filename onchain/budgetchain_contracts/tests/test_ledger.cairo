...
fn test_multiple_transactions() {
    ...
    let tx_id1 = dispatcher.create_transaction(1, recipient1, 500, 'fund_release', 'First funding');

    // Create second transaction
    let tx_id2 = dispatcher.create_transaction(1, recipient2, 300, 'payment', 'Service payment');

    // Create third transaction for different project
    let tx_id3 = dispatcher
        .create_transaction(2, recipient1, 200, 'fund_release', 'Second project funding');
...
fn test_create_transaction_zero_amount() {
    ...
    // This should panic
    dispatcher.create_transaction(1, recipient, 0, 'fund', 'Zero amount transaction');
...
fn test_create_transaction_zero_recipient() {
    ...
    // This should panic
    dispatcher.create_transaction(1, zero_address, 100, 'fund', 'Zero recipient transaction');
